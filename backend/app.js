...
// Behind a reverse proxy (Vercel, nginx, Render, etc.) so req.ip / rate limiting work correctly
app.set("trust proxy", 1);

// Reuses the cached connection on warm serverless invocations instead of reconnecting every request
connectDB();
